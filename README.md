...
[Открыть облачный API](https://gravity-api-service.fastapicloud.dev/docs) · [Репозиторий проекта](https://github.com/tester170/Gravity_API_Service)
...
**Зачем здесь API:** модель выполняет расчёты на сервере, а данные можно отправлять из Python-программы, мобильного приложения или веб-интерфейса. Клиентам не требуется устанавливать модель и её библиотеки. Для перехода с локального сервера на облачный достаточно изменить адрес запроса.
